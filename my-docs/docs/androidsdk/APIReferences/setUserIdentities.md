...
1.  **Configure the SDK Initialization:**
    ...
    ```java title="SDK Initialization for Raw Identifiers"
...
2.  **Send Identifiers Using Standard Keys and Raw Values:**
    ...
    ```java title="Sending Raw Cell Phone"
    Map<String, String> identities = new HashMap<>();
    ...
    ```java title="Sending Raw Login ID"
    Map<String, String> identities = new HashMap<>();
...
1.  **Configure the SDK Initialization:**
    ...
    ```java title="SDK Initialization for Pre-Hashed Identifiers"
    CollectOptions options = CollectOptions.builder(this)
        .credential("YOUR_WRITE_KEY")
...
2.  **Send Identifiers using `setUserIdentities`:**
    ...
    ```java title="Sending Pre-Hashed Email (SHA-256 Lowercase)"
    Map<String, String> identities = new HashMap<>();
    ...
    ```java title="Sending Pre-Hashed Cell Phone (SHA-256)"
    Map<String, String> identities = new HashMap<>();
    ...
    ```java title="Sending Pre-Hashed Login ID (SHA-256 Lowercase)"
    Map<String, String> identities = new HashMap<>();
...
<!-- SDK Performs Hashing Section START --------------------->
<div style={{"display": "flex", "alignItems": "baseline", "gap": "15px"}}>
...
1.  **Configure the SDK Initialization:**
    ...
    ```java title="SDK Initialization for SDK Hashing"
    CollectOptions options = CollectOptions.builder(this)
        .credential("YOUR_WRITE_KEY")
        .hashIdentities(true)
...
2.  **Send Identifiers using `setUserIdentities`:**
    ...
    ```java title="Sending Raw Email (SDK will hash)"
    Map<String, String> identities = new HashMap<>();
    ...
    ```java title="Sending Raw Cell Phone (SDK will hash)"
    Map<String, String> identities = new HashMap<>();
    identities.put("cellno", "1-1234567890");
    ...
    ```java title="Sending Raw Login ID (SDK will hash)"
    Map<String, String> identities = new HashMap<>();
