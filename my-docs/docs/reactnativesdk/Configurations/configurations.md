...
| `check_zeotap_vendor_consent`                       | Boolean                                  | For CMP case, if set to true, then the SDK checks for Zeotap Vendor (ID 1469) consent, while resolving GDPR consent to send the data. <br/> If set to false, then the SDK ignores Zeotap Vendor consent.                                                                   |
